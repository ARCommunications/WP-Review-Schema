...
function review_schema_admin_styles() {
    ...
    if ( !function_exists( 'vc_map' ) ) wp_enqueue_script( 'bsf_jquery_ui' );
                        ...
                        <div id="postbox-container-5" class="postbox-container">
                            <div class="meta-box-sortables ui-sortable">
                                <div class="postbox ">
                                    ...
                                    <h3 class="hndle"><span>Default Value for Item Review (<a href="http://www.ar.com.bd" target="_blank"><b>available as premium addon</b></a>)</span></h3>
                                    <div class="inside">
                                        <div class="table">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                (<a href="http://www.ar.com.bd" target="_blank"><b>available as premium addon</b></a>)
                                                            </td>
                                                        </tr>
                                                        <tr>
